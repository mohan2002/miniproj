    ...
    return (
        <div>
            ...
            <div className="mx-12 mt-10">
                ...
                <div className="w-auto mx-20 p-10 mt-10 text-center bg-gray-200 rounded-2xl hover:bg-gray-300">
                    ...
                    <img src={l2} className="mx-auto rounded-xl"></img>
                </div>
                <div  className="w-auto mx-20 p-10 mt-10 text-center bg-gray-200 rounded-2xl hover:bg-gray-300">
                    <h2>2. Income</h2>
                ...
                <div className="w-auto mx-20 p-10 mt-10 text-center mb-10 bg-gray-200 rounded-2xl hover:bg-gray-300">
                ...
                <div className="w-auto mx-20 p-10 mt-10 text-center mb-10 bg-gray-200 rounded-2xl hover:bg-gray-300">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/jgAsPXRhTLQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen className="mx-auto mt-10 rounded-3xl sm:h-82 w-72 "></iframe>
                </div>
            </div>
        </div>
    )
